<div>
    <section class="bg-white">
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div
                class="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-white sm:px-4 lg:px-4"
            >
                <div>
                    <img
                        class="w-full mx-auto"
                        src="https://images.pexels.com/photos/331684/pexels-photo-331684.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=11"
                        alt=""
                    />
